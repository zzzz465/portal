...
`
    ...
    assert.Equal(t, "Seoul", records[0].Metadata.Labels["region"])
    ...
    assert.Equal(t, "California", records[1].Metadata.Labels["region"])
    ...
    assert.Equal(t, "Tokyo", records[2].Metadata.Labels["region"])
    assert.Equal(t, "A", records[2].Metadata.Labels["service"])
    ...
    assert.Equal(t, "New York", records[3].Metadata.Labels["region"])
    assert.Equal(t, "B", records[3].Metadata.Labels["service"])
}
...
`
    ...
    assert.NotNilf(t, records[0].Metadata, "metadata should not be nil.")
    assert.Equal(t, "static", records[0].Metadata.DataSource)
    assert.Equal(t, "California", records[0].Metadata.Labels["region"])
}
